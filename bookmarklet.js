...
const poller = setInterval(() => {                                                          //Interval to poll the CoWin every DELTA mins.
	console.log(`Refresh No :: ${++cnt} | Time left : ${LIMIT - DELTA * cnt} mins.`);
